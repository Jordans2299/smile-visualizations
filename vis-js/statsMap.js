StatsMap = function(_parentElement, _data) {
...
StatsMap.prototype.initVis = function() {
    var vis = this;
...
StatsMap.prototype.wrangleData = function() {
 ...
 */
StatsMap.prototype.updateVis = function() {
    var vis = this;
    ...
    d3.json("data/continents.json").then(function(world) {
        ...
        vis.svg
            ...
            .on("click", function(event, d) {
                vis.drawStatsWheel(d.properties.name)
...
StatsMap.prototype.drawStatsWheel= function(name) {
